...
notebook_files1 = ['model.amr_userguide_project.my_second_dbt_model', 'test.amr_userguide_project.not_null_my_first_dbt_model_id.5fb22c2710', 'test.amr_userguide_project.unique_my_first_dbt_model_id.16e066b321'] # type: ignore
