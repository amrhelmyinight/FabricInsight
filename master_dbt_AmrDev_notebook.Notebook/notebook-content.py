...
gv_lakehouse = 'lh_fa_amr_raw'
gv_log_lakehouse = 'lh_fa_amr_conformed'
...
mssparkutils.notebook.run("metadata_dbt_AmrDev_extract")
...
embedded_hashes = [{'hash': 'f93496f9756363425203ef0410d9d6063a1883b1b2cea61fea56ef65e9b0b46b', 'file': 'ListSchemas.json'}, {'hash': '47305aeff4e39f136586c2cd08d52377fed2c589dedc7dd584ba694b58b090ce', 'file': 'DescribeRelations.json'}, {'hash': '3b2a6422f17eff556cd2da3cd75e44a665e5b5bbf6bac989cadc2dfeb091e680', 'file': 'ListRelations.json'}] # type: ignore
...
call_child_notebook("master_dbt_AmrDev_notebook_0", new_batch_id, master_notebook)
...
call_child_notebook("master_dbt_AmrDev_notebook_1", new_batch_id, master_notebook)
...
call_child_notebook("master_dbt_AmrDev_notebook_2", new_batch_id, master_notebook)
